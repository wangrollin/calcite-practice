package com.example.calcite_practice;
...
import com.example.calcite.sql.parser.impl.MySqlParserImpl;
...
//                        + "ORDER BY b.id\n"
//                        + "LIMIT 5"
                "select MAX(id) as mykeyword from Book limit 1"
                ,
                SqlParser
                    .config()
                    .withParserFactory(MySqlParserImpl.FACTORY)
        );
